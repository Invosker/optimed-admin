...
import { Command, CommandGroup, CommandItem, CommandList } from "@/Components/BaseComponents/ui/command";
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative min-h-[38px] rounded-lg border border-input text-sm ring-offset-background transition-shadow focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/30 focus-within:ring-offset-2 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50 -mt-2",
            {
