...
// Define the props for the Switch component by extending the Radix UI SwitchRootProps
export type SwitchProps = React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root>

const Switch = React.forwardRef<
  React.ElementRef<typeof SwitchPrimitives.Root>, // Specify the ref element type
  SwitchProps // Specify the component's props type
>(({ className, ...props }, ref) => (
